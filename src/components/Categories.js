...
export default class Categories extends Component {
  ...
  render() {
    return (
      <div className='cats'>
        <br></br> <br></br>
        <p className='emergency-logo'>WHAT IS YOUR EMERGENCY?</p>
        <br></br>
        ...
        <p className='crime-violence'>
          ...
          <p className='examples'>
            ...
            protection services, crisis lines/shelters/resources for abuse of
            specific populations, sexual assault reporting advocates,
            robbery/theft reporting, etc.
          </p>
        </p>
        <p className='environ-shelt'>
          <Link to='/environment-and-shelter'>
            <button className='env-shel-btn'>Environment & Shelter</button>
          </Link>
          <p className='examples'>
        ...
        <p className='animal'>
          ...
          <p className='examples'>
            ...
            rehabilitation centers, animal shelters, lost/found pet resources,
            etc.
          </p>
        </p>
      </div>
