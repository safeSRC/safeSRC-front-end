...
//       info: [this.state.st_address, this.state.county, this.state.zip, this.state.usstate, this.state.number, this.state.altnumber, this.state.email, this.state.website],
