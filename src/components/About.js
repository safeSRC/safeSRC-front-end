      ...
      <div>
        ...
        <div className='us'>
          <section className='ben'>
            <h1>Ben</h1>
            <p className='bio'>
              I'm a software developer with a knack for working with teams and
              ...
              kitchens as a chef working closely with teams of all backgrounds,
              I feel like I am adept at meeting teammates where they are with
              respect and enough motivation to keep everyone focused on the task
              at hand. I can be an asset with my ability to work on a team and
          ...
          <section className='dimitra'>
            <h1>Dimitra</h1>
            <p className='bio'>
              A fast visual and tactile learner that takes practical approaches
              to write readable code for humans AND computers loves manipulating
              data and has a keen eye for art & design. Interested in creating
              apps and supporting organizations with a mission-driven mindset, I
              am passionate about developing and providing solutions to everyday
              problems. I would like to use my coding experience to help people
              achieve their goals, give access to resources, and effect positive
              change in their local communities and abroad
            </p>
          ...
          <section className='maria'>
            <h1>Maria</h1>
            <p className='bio'>
              A full-stack software engineer with a passion for creativity and
              coding. I enjoy integrating lots of creativity within code, as
              coding is another medium that allows people to express themselves.
              I love to get lost in fantasy and to bring that fantasy to life
              with my drawings and art. When I am not coding or drawing, I love
              to fill my time with video games and TTRPGs with friends and
              family!
            </p>
            <a href='https://github.com/MariaOrtiz1'>GitHub</a>
            <a href='https://www.linkedin.com/in/maria-ortiz-lopez-54392a211/'>
              LinkedIn
            </a>
          </section>
          <section className='sofia'>
            ...
            <p className='bio'>
              ...
              learning to be a better photographer, or reading novels. My
